 ...
 * Nov 29, 2022
 *
 * This program encrypts a text script and a key produced by our keygen.
 * To use, compile using gcc -o enc_client enc_client.c and run using
 * $./enc_client [FILE TO BE ENCRYPTED] [KEY MADE BY KEYGEN] [PORT]
 */
