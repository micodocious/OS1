 ...
 * Nov 29, 2022
 * 
 * enc_server does the actual encryption. The server will send a signal to made sure
 * enc_client and NOT dec_client is the one connecting to the server. 
 * To use, compile using gcc -o enc_server enc_server.c and run using 
